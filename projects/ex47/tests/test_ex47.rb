...
class TestGame < Test::Unit::TestCase
  ...
  class << self
    def startup()
      puts "=== startup() runs before test class ==="
    end

    def shutdown()
      puts "=== shutdown() runs after test class ==="
    end
  end

  def setup()
    puts "=== setup() runs before each test method ==="
  end

  def cleanup()
    puts "=== cleanup() runs after each test method ==="
  end

  attribute :room, :simple
  def test_room()
